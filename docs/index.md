...
* [redis_string](datasources/string.md) - Reads Redis string key value.
...
2. Extract the binary to your Terraform plugins directory:
   - Linux: `~/.terraform.d/plugins/registry.terraform.io/zbooyo/redis/`
   - Windows: `%APPDATA%\terraform.d\plugins\registry.terraform.io\zbooyo\redis\`

## Support

For support, please open an issue on [GitHub](https://github.com/zbooyo/terraform-provider-redis/issues).

## License

This project is licensed under the MIT License - see the [LICENSE](https://github.com/zbooyo/terraform-provider-redis/blob/main/LICENSE) file for details.
